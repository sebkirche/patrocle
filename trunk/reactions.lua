   ...
   if canTalk then
	 ...
	 --j'ai faim
	  ...
	  if Flags.AGE and Flags.AS_TU and (Flags.NOM or not isChannel) then
		 repondre(from, to,
				  1, {"J'ai l'âge d'un bébé, mais le cerveau d'un génie, %s. ;)", "Ça t'intéresse, %s?", "Je n'ai pas d'âge au sens où tu l'entends, %s.", "%s: Je suis éternel! :]", "C'est quoi un âge, %s?", "/me n'a pas d'âge."},
